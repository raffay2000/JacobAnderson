    ...
    GetAllEvents_ByUser = () => {
        if(!that.state.loading && !that.state.isListEnd){
            ...
            .then(function (response) {
                ...
                if(response.data.data.length == 0 && that.state.offset ==1){
                    that.setState({ 
                        success:true,
                ...
                if(response.data.data.length > 0){
                    // console.log('type', that.state.Events_ByUser.length)
                    if(that.state.Events_ByUser.length>0 && that.state.offset==1 ){
                        that.setState({ 
                            success:true,
