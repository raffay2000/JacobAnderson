...
class CreateEvent extends React.Component {
    ...
    onCreateEventPress = () => {
       ...
       else if( this.props.EventImg[0] == "" && this.props.EventImg[1] == ""&& this.props.EventImg[2] == ""&& this.props.EventImg[3] == ""){
    ...
    componentDidUpdate(){
        console.log('get images',this.props.EventImg)
    }
    seatIncrement = () => {
        ...
        return(
            <Container>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={[styles.row,{justifyContent:'space-between',alignSelf:'center',}]}>
                    ...
                    <View style={[styles.row, {justifyContent:"space-around"}]} >
                        <ImagePickerExample index={0} OnImagePick={this.OnImagePick} imagesArr={this.props.EventImg} selectImg={this.props.EventImg[0] ? this.props.EventImg[0] : null}  />
                        <ImagePickerExample index={1} OnImagePick={this.OnImagePick} imagesArr={this.props.EventImg} selectImg={this.props.EventImg[1] ? this.props.EventImg[1] : null} />
                        <ImagePickerExample index={2} OnImagePick={this.OnImagePick} imagesArr={this.props.EventImg} selectImg={this.props.EventImg[2] ? this.props.EventImg[2] : null} />
                        <ImagePickerExample index={3} OnImagePick={this.OnImagePick} imagesArr={this.props.EventImg} selectImg={this.props.EventImg[3] ? this.props.EventImg[3] : null} />
                    </View>
