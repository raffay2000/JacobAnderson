    ...
    return (
        <View style={[styles.container,{backgroundColor:colors.primary}]}>
            ...
            <View style={styles.tabContainer}>
                <TouchableWithoutFeedback style={styles.tab}>
                    <View style={styles.tab}><Text style={styles.tabText}>Individual</Text></View>
                </TouchableWithoutFeedback>
                <TouchableWithoutFeedback >
                    <View style={styles.tab}><Text style={styles.tabText}>Business</Text></View>
                </TouchableWithoutFeedback>
            </View>
