        ...
        <View style={[styles.container,{backgroundColor:colors.primary}]}>
            ...
            <View style={styles.tabContainer}>
                <TouchableWithoutFeedback onPress={toggleTab} style={styles.tab}>
                    <View style={[styles.tab,switchTab && {backgroundColor: purple}]}><Text style={styles.tabText}>Individual</Text></View>
                </TouchableWithoutFeedback>
                <TouchableWithoutFeedback onPress={toggleTab}>
                    <View style={[styles.tab,switchTab && {backgroundColor: purple}]}><Text style={styles.tabText}>Business</Text></View>
                </TouchableWithoutFeedback>
            </View>
