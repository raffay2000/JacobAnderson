        ...
        return (
            <View style={[styles.container,{backgroundColor:primary}]}>
                ...
                <Text style={styles.Para}>
                    Email verification code has been send on <Text style={[styles.Para, {color:white, fontFamily:"Bold", fontSize:hp("2.6%")}]} >{this.state.VerifyEmail}</Text>, Kindly enter your code to change your Password, Thank You!
                </Text>
                <IconInput
