...
class CreateEvent extends React.Component {
    ...
    render(){
        const {text} = this.props.route.params.colors
        return(
            <Container>
                <Header
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <Text style={[styles.heading,{color:text}]}>Add Event Date</Text>
                    ...
                    <Text style={[styles.heading,{color:text}]}>Add Event Reservation</Text>
                    <View style={[styles.row,{justifyContent:'space-between',alignSelf:'center', marginTop:0}]}>
                        <IconInput
