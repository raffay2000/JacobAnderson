            ...
            <Container>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <IconInput
                        ...
                        inputRef={input => address1 = input}
                        onChange={(text)=>this.setState({address1:text})}
                        iconColor={gray}
                        onSubmitPress={()=>address2.focus()}
                        blur={false}
                    />
                    <View style={styles.row}>
                        <IconInput
                            ...
                            iconColor={gray}
                            inputRef={input => address2 = input}
                            onSubmitPress={()=>DD.focus()}
                            blur={false}
                        />
                    ...
                    <View style={[styles.row,{justifyContent:'space-between',alignSelf:'center', marginTop:0}]}>
                        <IconInput
                            ...
                            iconColor={gray}
                            inputRef={input => DD = input}
                            onSubmitPress={()=>MM.focus()}
                            blur={false}
                        />
                        <IconInput
                            style={[styles.input,{width:hp('10%')}]}
                            ...
                            iconColor={gray}
                            inputRef={input => MM = input}
                            onSubmitPress={()=>YY.focus()}
                            blur={false}
                        />
                        <IconInput
                            style={[styles.input,{width:hp('10%')}]}
                    ...
                    <View style={[styles.row,{justifyContent:'space-between',alignSelf:'center', marginTop:0}]}>
                        <IconInput
                            ...
                            iconColor={gray}
                            keyboard="number-pad"
                            inputRef={input => reservation = input}
