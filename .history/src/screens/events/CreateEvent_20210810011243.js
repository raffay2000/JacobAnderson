            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={[styles.row,{justifyContent:'space-between',alignSelf:'center', marginTop:0}]}>
                    <IconInput
                        ...
                        blur={false}
                    />
                    <MaterialIcons name="keyboard-arrow-up" size={24} onPress={()=>alert('up')} style={[styles.arrowIcon]}/>
                    <MaterialIcons name="keyboard-arrow-down" size={24} onPress={()=>alert('down')} style={styles.arrowIcon}/>
                </View>
                {/* <View style={styles.row}>
                    <Image/>
                </View> */}
