...
const EventDetails = ({route}) => {
    ...
    const [isFavorite, setIsFavorite] = useState(route.params.favorite);
    ...
    const [Cancel_Loader, SetCancel_Loader] = useState(true);
    ...
    const getImages = () => {
        ...
        EventDetails?.images.map(image=>
            imgArr.push(imgPath+'/'+image.event_image)
        )
        console.log(imgArr)
        return imgArr;
    }
    ...
    const Event_Cancel = () => {
        ...
        .then(function (response) {
            if(response.data.success){
                ...
                Toast.show({text1: "Couldn't Delete this Event"})
                    ...
                    Loader?
                        ...
                        Failed || EventDetails == null
                            ...
                            <AwesomeAlert 
                                ...
                                contentContainerStyle={{ backgroundColor:"white", width:"80%" , height: Cancel_Loader ? hp('25%') : hp('22%') }}
