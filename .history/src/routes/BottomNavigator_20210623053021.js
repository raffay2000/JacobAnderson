  ...
  return (
      ...
      >
        <Tab.Screen 
            options={{
                tabBarIcon: ({ focused }) => (
                  focused ? <Icon color={white} size={28} name={'home'}/> :<Icon color={'blue'} size={28} name={'md-home'}/>
                ),  
        ...
        <Tab.Screen 
            options={{
                tabBarIcon: ({ focused }) => (
                    focused ? <Icon color={white} size={28} name={'heart'}/> : <Icon color={'blue'} size={28} name={'heart'} />
                ),  
            }} 
            name="Events" 
        ...
        <Tab.Screen 
            options={{
                tabBarIcon: ({ focused }) => (
                    focused ? <Icon color={white} size={28} name={'compass'}/> : <Icon color={'blue'} size={28} name={'compass'}/>
                ),  
            }} 
            name="Notifications" 
        ...
        <Tab.Screen 
            options={{
                tabBarIcon: ({ focused }) => (
                    focused ? <Icon color={white} size={28} name={'shopping-cart'}/> : <Icon color={'blue'} size={28} name={'shopping-cart'}/>
                ),  
