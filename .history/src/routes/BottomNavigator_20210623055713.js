      ...
      >
        <Tab.Screen 
            options={{
                ...
                tabBarIcon: ({ focused }) => (
                    <>
                        <Icon color={white} size={focused ? 30 : 25} name={'md-home'}/>
                        {focused&& <Text style={{fontSize:10, color:white, fontFamily:"Regular"}}>Home</Text>}
                    </>
                ),  
        ...
        <Tab.Screen 
            options={{
                tabBarIcon: ({ focused }) => (
                    <>
                        <Fontisto color={white} size={focused ? 28 : 25} name={'star'}/> 
                        {focused&& <Text style={{fontSize:12, color:white, fontFamily:"Regular"}}>Events</Text>}
                    </>
                ),  
            }} 
            name="Events" 
        ...
        <Tab.Screen 
            options={{
                tabBarIcon: ({ focused }) => (
                    <>
                        <Icon color={white} size={focused ? 28 : 25} name={'notifications'}/>
                        {focused&& <Text style={{fontSize:12, color:white, fontFamily:"Regular"}}>Notifications</Text>}
                    </>
                ),
            }} 
            name="Notifications" 
        ...
        <Tab.Screen 
            options={{
                tabBarIcon: ({ focused }) => (
                    <>
                        <Icon color={white} size={focused ? 28 : 25} name={'list-sharp'}/>
                        {focused&& <Text style={{fontSize:12, color:white, fontFamily:"Regular"}}>Categories</Text>}
                    </>
                ),
