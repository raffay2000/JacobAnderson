            ...
            options={{
                tabBarIcon: ({ focused }) => (
                    <>
                        ...
                        {focused&& <Text style={{fontSize:10, color:white, fontFamily:"Regular"}}>Events</Text>}
                    </>
                ),  
            }} 
            name="Events" 
            ...
            options={{
                tabBarIcon: ({ focused }) => (
                    <>
                        ...
                        {focused&& <Text style={{fontSize:10, color:white, fontFamily:"Regular"}}>Notifications</Text>}
                    </>
                ),
            }} 
            name="Notifications" 
            ...
            options={{
                tabBarIcon: ({ focused }) => (
                    <>
                        ...
                        {focused&& <Text style={{fontSize:10, color:white, fontFamily:"Regular"}}>Categories</Text>}
                    </>
                ),
