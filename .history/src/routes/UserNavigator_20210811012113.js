...
export default function App(){
    ...
    return(
        ...
        >
            <Stack.Screen initialParams={{colors}} name="UserNavigator" component={UserNavigator} />
            <Stack.Screen initialParams={{colors}} options={{ cardStyleInterpolator: Slide }} name="HomeStack" component={HomeStack} />
            <Stack.Screen initialParams={{colors}} options={{ cardStyleInterpolator: Slide }} name="EventsStack" component={EventsStack} />
            ...
            <Stack.Screen initialParams={{colors}} options={{ cardStyleInterpolator: Slide }} name="CategoriesStack" component={CategoriesStack} />
