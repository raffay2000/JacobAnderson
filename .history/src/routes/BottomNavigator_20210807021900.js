...
export default function App(){
    ...
    return(
        ...
        >
            ...
            <Stack.Screen options={{ cardStyleInterpolator: ForSlide }} name="EventsStack" component={EventsStack} />
            <Stack.Screen options={{ cardStyleInterpolator: ForSlide }} name="MessagesStack" component={MessagesStack} />
            <Stack.Screen options={{ cardStyleInterpolator: ForSlide }} name="NotificationsStack" component={NotificationsStack} />
            <Stack.Screen options={{ cardStyleInterpolator: ForSlide }} name="CategoriesStack" component={CategoriesStack} />
            <Stack.Screen options={{ cardStyleInterpolator: ForSlide }} name="OtherStack" component={OtherStack}/>
        </Stack.Navigator>
        </>
    )
  }
