...
import { black, darkGray, gray, yellow } from '../../assets/colors';
...
const Review = (review) => {
    ...
    return(
        <View>
            ...
            <Text style={[styles.text,{ color:colors.text, marginTop:hp('1%'), paddingBottom:hp('2%'), borderBottomWidth:2, borderBottomColor:gray,}]}>
            ...
            <View style={[styles.row,{justifyContent:'space-between'}]}>
                ...
                <View style={styles.row}>
                    <StarRating
                        ...
                        // selectedStar={(rating) => this.onStarRatingPress(rating)}
                    />
                    <Text style={[styles.text,{marginLeft:hp('1%')}]}>220 Reviews</Text>
                </View>
            </View>
            <Review/>
            <Review/>
