    ...
    return(
        <View style={styles.container}>
            <View>
                ...
                <Text style={[styles.text,{marginVertical:hp('2%'), color: colors.border}]}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the</Text>
                <Button
                    text={"Create Event"}
