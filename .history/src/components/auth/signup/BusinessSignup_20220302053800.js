...
class BusinessSignup extends Component{
    ...
    componentDidMount(){
        ...
        console.log(this.props._Categories)
    }
        ...
        return (
            <>
                ...
                <View style={[styles.row, {marginTop:hp("2%"), justifyContent:"space-between"}]} >
                    <ImagePickerExample OnImagePick={this.OnImagePick} style={{backgroundColor:purple}} selectImg={this.props.AddImg[0] ? this.props.AddImg[0]: null}  />
                    <ImagePickerExample OnImagePick={this.OnImagePick} style={{backgroundColor:purple}} selectImg={this.props.AddImg[1] ? this.props.AddImg[1]: null} />
                    <ImagePickerExample OnImagePick={this.OnImagePick} style={{backgroundColor:purple}} selectImg={this.props.AddImg[2] ? this.props.AddImg[2]: null} />
                    <ImagePickerExample OnImagePick={this.OnImagePick} style={{backgroundColor:purple}} selectImg={this.props.AddImg[3] ? this.props.AddImg[3]: null} />
                </View>
