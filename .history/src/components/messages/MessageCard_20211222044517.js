...
import { black, darkGray, gray, lightGray, primary } from '../../assets/colors';
import { Ionicons } from '@expo/vector-icons';
import {useTheme} from '../../theme/ThemeContext'; 
import { manageDate } from '../../utils';
import ImageLoader from '../common/ImageLoader';

const MessageCard = ({side, data, toPhoto, fromPhoto}) => {
    console.log(toPhoto, fromPhoto)
    ...
    const textStyles = isLeftSide ? [flattenedStyles.leftText,{color:colors.text}] : [flattenedStyles.rightText,{color:colors.text}];
    ...
    return(
        <>
            <View style={containerStyles}>
                {isLeftSide &&
                    <Image 
                        source={toPhoto == null ? require('../../assets/images/avatar.png') : {uri: toPhoto }}
                ...
                {!isLeftSide &&
                    <Image 
                        source={fromPhoto ? {uri: fromPhoto } : require('../../assets/images/avatar.png')}
                        style={styles.imageStyle}
                    />
                }
            </View>
