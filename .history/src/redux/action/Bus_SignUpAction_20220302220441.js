...
export const Business_SignUp = (Name, Email, Password, Conf_Password, Category, Description, PhoneNumber, Address1, Address2,AddImg) => {
    return(dispatch) => {
...
export const AddImg = (index, image, ImageArray=[]) =>{
    ...
    const images = ImageArray;
    images[index] = image;
    console.log('from action',images)
    return{
        type:ADD_IMG,
        payload:images
    }
